...
////字符串 --> 浮点型
//-(float)strToFloat:(NSString*)string{
//    
//    NSString *second = [string substringWithRange:NSMakeRange(3, 2)];
//    NSString *minute = [string substringWithRange:NSMakeRange(0, 2)];
//    float time = [minute floatValue]*60 + [second floatValue];
//    
//    return time;
//}
